...
extern void blk_sec_stat_account_io_finish(struct request *rq,
		void *ptr_pio);
#else
#define blk_sec_stat_account_init(q)	do {} while(0)
#define blk_sec_stat_account_exit(eq)	do {} while(0)
#define blk_sec_stat_account_io_prepare(rq,p) do{} while(0)
#define blk_sec_stat_account_io_complete(rq,da,pio) do{} while(0)
#define blk_sec_stat_account_io_finish(rq,io) do{} while(0)
#endif
