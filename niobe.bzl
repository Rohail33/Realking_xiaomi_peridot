...
def define_niobe():
    ...
    _niobe_in_tree_modules = target_arch_in_tree_modules
    _niobe_consolidate_in_tree_modules =target_arch_in_tree_modules + target_arch_consolidate_in_tree_modules
